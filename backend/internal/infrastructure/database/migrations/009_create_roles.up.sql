...
-- Create roles and role_permissions tables for dynamic RBAC persistence.
...
-- 2. Role permissions table (1:N, cascades on role delete)
...
-- 3. Seed the 4 built-in system roles
--    Use fixed UUIDs matching the in-memory stubs so existing code references remain valid.
...
-- 4. Seed default permissions for super_admin (all read + write)
...
-- 5. Seed default permissions for operations
INSERT INTO role_permissions (role_id, permission_key, read, write) VALUES
...
-- 6. Seed default permissions for finance
INSERT INTO role_permissions (role_id, permission_key, read, write) VALUES
...
-- 7. Seed default permissions for support (read-only)
INSERT INTO role_permissions (role_id, permission_key, read, write) VALUES
