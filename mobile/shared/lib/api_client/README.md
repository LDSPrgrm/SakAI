...
- `event` — one of the values in the `WsEventType` enum.
- `payload` — event-specific payload; see `WsEnvelope.payload` oneOf in
  `components/schemas` for the per-event shape.
- `timestamp` — RFC3339 UTC timestamp stamped by the server when the
  envelope is built. Optional on the wire for backward compatibility
  (older servers omit it); clients should tolerate its absence.
- `event_id` — UUIDv7 stamped by the server. Enables client-side
  idempotency / dedup. Optional for backward compatibility.
...
[*AdminApi*](doc/AdminApi.md) | [**listAssigneeCandidates**](doc/AdminApi.md#listassigneecandidates) | **GET** /admin/support-staff | List candidate assignees for incident reassignment
...
## Documentation For Models
 ...
 - [FareBreakdown](doc/FareBreakdown.md)
 ...
 - [ListAssigneeCandidates200ResponseInner](doc/ListAssigneeCandidates200ResponseInner.md)
 ...
 - [WsEnvelopePayload](doc/WsEnvelopePayload.md)
 - [WsEventConnWelcome](doc/WsEventConnWelcome.md)
 - [WsEventDriverLocationUpdated](doc/WsEventDriverLocationUpdated.md)
 - [WsEventIncidentAssigned](doc/WsEventIncidentAssigned.md)
 - [WsEventIncidentResolved](doc/WsEventIncidentResolved.md)
 ...
 - [WsEventRideCompleted](doc/WsEventRideCompleted.md)
 ...
 - [WsEventRideSOSTriggered](doc/WsEventRideSOSTriggered.md)
 - [WsEventRideStateSync](doc/WsEventRideStateSync.md)
 - [WsEventRideStatusChanged](doc/WsEventRideStatusChanged.md)
 - [WsEventType](doc/WsEventType.md)
