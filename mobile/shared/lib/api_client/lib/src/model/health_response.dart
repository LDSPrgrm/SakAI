...
abstract class HealthResponse implements Built<HealthResponse, HealthResponseBuilder> {
  ...
  HealthResponseDependencies? get dependencies;
...
class _$HealthResponseSerializer implements PrimitiveSerializer<HealthResponse> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.dependencies != null) {
      ...
      yield serializers.serialize(
        object.dependencies,
        specifiedType: const FullType(HealthResponseDependencies),
      );
    }
  }
...
class HealthResponseStatusEnum extends EnumClass {
  ...
  static const HealthResponseStatusEnum down = _$healthResponseStatusEnum_down;
