...
const HealthResponseStatusEnum _$healthResponseStatusEnum_down =
    const HealthResponseStatusEnum._('down');
...
HealthResponseStatusEnum _$healthResponseStatusEnumValueOf(String name) {
  switch (name) {
    ...
    case 'down':
      return _$healthResponseStatusEnum_down;
    default:
...
class _$HealthResponse extends HealthResponse {
  ...
  @override
  final HealthResponseDependencies? dependencies;
...
class HealthResponseBuilder
  ...
  HealthResponseDependenciesBuilder? _dependencies;
  HealthResponseDependenciesBuilder get dependencies =>
      _$this._dependencies ??= HealthResponseDependenciesBuilder();
  set dependencies(HealthResponseDependenciesBuilder? dependencies) =>
