...
///
/// Properties:
/// * [refreshToken] - Long-lived refresh token received from login/register/previous refresh.
@BuiltValue()
abstract class RefreshRequest implements Built<RefreshRequest, RefreshRequestBuilder> {
  /// Long-lived refresh token received from login/register/previous refresh.
