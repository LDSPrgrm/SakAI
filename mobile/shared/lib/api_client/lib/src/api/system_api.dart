...
class SystemApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ServiceAreaResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ServiceAreaResponse>> getServiceAreas({ 
    ...
    ServiceAreaResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ServiceAreaResponse),
    ...
    return Response<ServiceAreaResponse>(
      data: _responseData,
