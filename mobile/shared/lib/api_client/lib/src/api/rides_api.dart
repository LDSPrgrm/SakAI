...
class RidesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [TipResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TipResponse>> addRideTip({ 
    required String rideId,
    required AddRideTipRequest addRideTipRequest,
    ...
    final _path = r'/rides/{rideId}/tip'.replaceAll('{' r'rideId' '}', encodeQueryParameter(_serializers, rideId, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(AddRideTipRequest);
      _bodyData = _serializers.serialize(addRideTipRequest, specifiedType: _type);
    ...
    TipResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TipResponse),
      ) as TipResponse;
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ReceiptResponse>> getRideReceipt({ 
    required String rideId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/rides/{rideId}/receipt'.replaceAll('{' r'rideId' '}', encodeQueryParameter(_serializers, rideId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [idempotencyKey] - Client-generated UUID to prevent duplicate ride creation on retries. Generate once per request attempt and store until a definitive response is received. 
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaymentResponse>> paymentProcess({ 
    required String idempotencyKey,
    required PaymentProcessRequest paymentProcessRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/payments/process';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
    ...
    try {
      const _type = FullType(PaymentProcessRequest);
      _bodyData = _serializers.serialize(paymentProcessRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RideResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RideResponse>> rideAccept({ 
    required String rideId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [RideResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RideResponse>> rideCancel({ 
    required String rideId,
  ...
  /// Returns a [Future] containing a [Response] with a [RideResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RideResponse>> rideDecline({ 
    required String rideId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [RideResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RideResponse>> rideGet({ 
    required String rideId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [RideResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RideResponse>> rideGetActive({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [status] - Filter by status (comma-separated): completed,cancelled
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserRideListResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserRideListResponse>> rideList({ 
    int? page = 1,
    int? limit = 20,
    String? status,
    CancelToken? cancelToken,
    ...
    UserRideListResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(UserRideListResponse),
      ) as UserRideListResponse;
    ...
    return Response<UserRideListResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [RideResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RideResponse>> rideRequest({ 
    required String idempotencyKey,
    required RideRequestBody rideRequestBody,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(RideRequestBody);
      _bodyData = _serializers.serialize(rideRequestBody, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [RideResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RideResponse>> rideStart({ 
    required String rideId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RatingResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RatingResponse>> submitRating({ 
    required String rideId,
    required SubmitRatingRequest submitRatingRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/rides/{rideId}/rating'.replaceAll('{' r'rideId' '}', encodeQueryParameter(_serializers, rideId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SubmitRatingRequest);
      _bodyData = _serializers.serialize(submitRatingRequest, specifiedType: _type);
    ...
    RatingResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RatingResponse),
      ) as RatingResponse;
